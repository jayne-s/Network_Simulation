...
public abstract class Host {
    ...
    private FutureEventList fel; // list of Message objects and Timer objects
    ...
    public int getCurrentTime() {
        // System.out.println(this.fel.size());
    ...
    public void addNeighbor(Host neighbor, int distance) {
        ...
        //  System.out.println(neighbor.address + " " + distance);
        // System.out.println("Neighbor Distance Map Size: " + this.neighborDistance.size());
        //System.out.println("Neighbor Map Size: " + this.neighbor.size());
    }
    ...
    protected void sendToNeighbor(Message msg) {
        ...
        // System.out.println("NEIGBOR: " + this.neighbor.get(msg.getDestAddress()));
        if (neighbor == null) {
             throw new EventException("sendToNeighbor: destination address of message is unknown: " + msg.getDestAddress());
        }
        //  System.out.println("GET DEST ADDRESS: " + msg.getDestAddress());
        //   System.out.println("GET neighbor: " + this.neighborDistance);
        // neighbor = this.neighbor.get(5);
        ...
        // System.out.println("FEL List Size: " + this.fel.size());
    }
    ...
    protected int newTimer(int duration) {
       ...
       // System.out.println("TIMER ADDED: " + timer.getId() + " " + timer.getArrivalTime());
        this.activeTimers.put(timer.getId(), timer);
        // System.out.println("FEL List Total Size:" + this.fel.size());
        return timer.getId();
    }
    ...
    protected void onTimerExpiry(Timer timer) {
       ...
       // System.out.println("TIMER REMOVED: " + timer.getId() + " "  + timer.getArrivalTime());
